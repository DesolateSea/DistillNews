...
<<<<<<< HEAD:backend/pipeline/sources/media_stack.py
...
try:
    ...
    log = None
>>>>>>> 582a92f (refactor: The code base has sperated the pipelines completely from the):pipeline/sources/media_stack.py
