...
<<<<<<< HEAD:backend/pipeline/sources/rapid_news.py
...
try:
    ...
    log = None
>>>>>>> 582a92f (refactor: The code base has sperated the pipelines completely from the):pipeline/sources/rapid_news.py
